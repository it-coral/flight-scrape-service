...
urlpatterns = [
    ...
    url(r'^get_aircraft_category$', get_aircraft_category, name='get_aircraft_category'),
#    url(r'', include('social_auth.urls')),
    ...
    url(r'^2915653.html$', lambda r: HttpResponse("<title>2915653.html</title>")),
    ...
    url(r'^modify_config', modify_config, name='modify_config'),
    url(r'^get_history', get_history, name='get_history'),
    
    url(r'^choose_kind', choose_kind, name='choose_kind'),
