...
def Admin(request):
    ...
    stat_num_search = [['aeroflot', 3135], ['airchina', 2164], ['american airlines', 3067], ['delta', 36487], ['etihad', 1283], ['jetblue', 4456], ['s7', 4175], ['united', 171065], ['Virgin America', 3779], ['Virgin Australia', 10235], ['virgin_atlantic', 3013]]
